...
def create_app():
    ...
    from app.routes import admin_routes, home_routes, login_routes, logout_routes, admin_pdf_routes, admin_user_routes, admin_pdf_generate_routes, admin_pdf_edit_routes, admin_pdf_delete_routes, user_procedimentos_routes, process_chat_routes, admin_user_generate_routes, admin_user_delete_routes, admin_user_edit_routes, user_show_pdf_routes
